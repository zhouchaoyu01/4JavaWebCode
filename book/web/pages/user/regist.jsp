    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#username").blur(function () {
                ...
                $.getJSON("http://localhost:8080/book/userServlet", "action=ajaxExistUsername&username=" + username,
                    function (data) {
                        // console.log(data);
                ...
                <div class="form">
                    <form action="userServlet" method="post">
                        ...
                        <img id="code_img" alt="" src="kaptcha.jpg"
                             style="float: right; margin-right: 50px; width: 100px; height:36px">
                        <br/>
                        <br/>
